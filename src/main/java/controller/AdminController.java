 ...
 * @author nsqa
 */
@WebServlet(name = "AdminController", urlPatterns = {"/admin", "/admin-config", "/admin-update", "/admin-pay", "/admin-add-info", "/admin-config-update", "/admin-config-add"})
public class AdminController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (u != null && u.getRole().equalsIgnoreCase("admin")) doPost(request, response);
        else response.sendRedirect(request.getContextPath() + "/show_Login");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(request.getServletPath()) {
            case "/admin":
                List<ElecInfo> infos = infoDao.findAll();
