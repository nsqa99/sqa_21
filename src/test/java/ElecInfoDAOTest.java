...
public class ElecInfoDAOTest {
    ...
    private final Connection con = ElecInfoDAO.con;
    ...
    public void testFindAll() {
        ElecInfo info1 = new ElecInfo(1, "Nguyễn Sỹ Quang Anh", "Hà Đông, Hà Nội", "1234567890", "04/2021", 423, dao.calculateTotal(423, 1), "P", 1, 1);
        ElecInfo info2 = new ElecInfo(2, "Lê Thế Anh", "Hà Đông, Hà Nội", "1234567890", "04/2021", 120, dao.calculateTotal(120, 1), "NP", 2, 1);
        ElecInfo info3 = new ElecInfo(13, "Nguyễn Sỹ Quang Anh", "Hà Đông, Hà Nội", "1234567890", "05/2021", 200, dao.calculateTotal(200, 1), "NP", 1, 1);
        ElecInfo info4 = new ElecInfo(14, "Lê Thế Anh", "Hà Đông, Hà Nội", "1234567890", "05/2021", 200, dao.calculateTotal(200, 1), "NP", 2, 1);
    ...
    @Test
    public void testHandInMoney() throws Exception {
		con.setAutoCommit(false);
		dao.handInMoney(2);
		ElecInfo actual = dao.findById(2);
		ElecInfo expect = new ElecInfo(2, "Lê Thế Anh", "Hà Đông, Hà Nội", "1234567890", "04/2021", 120, dao.calculateTotal(120, 1), "P", 2, 1);
